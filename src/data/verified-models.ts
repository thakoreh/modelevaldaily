...
export const VERIFIED_MODELS: VerifiedModel[] = [
	{
		...
		contextWindow: '200K',
		bestFor: ['Highest intelligence tasks', 'Complex reasoning', 'Critical decisions'],
		scores: { coding: 9.6, reasoning: 9.7, toolUse: 9.4 },
		strengths: ['Top-tier intelligence', 'Adaptive thinking', 'Best for complex reasoning'],
		sources: [
	...
	},
	{
		...
		scores: { coding: 9.6, reasoning: 9.5, toolUse: 9.5 },
	...
	},
	{
		...
		scores: { coding: 9.4, reasoning: 9.5, toolUse: 9.2 },
	...
	},
	{
		...
		strengths: ['Top-tier intelligence', 'Low API cost', 'Strong bilingual support'],
		sources: [
	...
	},
	{
		...
		scores: { coding: 9.1, reasoning: 9.0, toolUse: 8.9 },
	...
	},
	{
		...
		scores: { coding: 8.6, reasoning: 8.7, toolUse: 8.4 },
		strengths: ['Largest context window (10M)', 'Open source', 'Good for long documents'],
		sources: [
	...
	},
	{
		...
		scores: { coding: 8.7, reasoning: 8.6, toolUse: 8.3 },
	...
	},
	{
		...
		strengths: ['Lowest cost option', 'Fastest output speed (499 t/s)', 'Good for simple tasks'],
		sources: [
			{ label: 'Gemini Model List', url: 'https://ai.google.dev/gemini-api/docs/models' },
			{ label: 'Gemini API Pricing', url: 'https://ai.google.dev/gemini-api/docs/pricing' },
		],
